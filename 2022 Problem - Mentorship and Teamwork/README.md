...
![The 3 projects that are described in the input.](images/input_projects.png)
...
![Projects execution timeline based on the input data set and the submission from the previous sections.](images/schedule.png)
