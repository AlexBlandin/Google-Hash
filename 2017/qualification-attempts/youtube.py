...
while space_for_videos and videos_to_cache:
  ...
  if debug:
    print(f"Video priorities: {video_priorities}")  # noqa: T201
...
print(f"Utilised {utilised_cache_count} caches")  # noqa: T201
print(f"Caches: {utilised_caches}")  # noqa: T201
...
print(f"Score: {score}")  # noqa: T201
print(f"Optimal: {optimum_savings}")  # noqa: T201
print(f"Efficiency: {score / optimum_savings:%}")  # noqa: T201
