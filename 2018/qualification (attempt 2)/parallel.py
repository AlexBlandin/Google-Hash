...
if __name__ == "__main__":
  try:
    ...
    pass
  # print(f"Stopped by user, top score is {top_score}")  # type: ignore  # noqa: PGH003
  """
  File format
  ...
  # if top_score > recorded_score:  # type: ignore  # noqa: PGH003
  #   with Path("d_metropolis.out").open("w", encoding="utf8") as o:
  #     for car in top_fleet:  # type: ignore  # noqa: PGH003
