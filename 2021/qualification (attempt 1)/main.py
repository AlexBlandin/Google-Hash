...
def read(name):  # noqa: ANN001, ANN201, D103
  ...
  for streetname, street in streets.items():
    intersections[street.ends_at].inputs.append(streetname)  # type: ignore  # noqa: PGH003
    intersections[street.starts_at].outputs.append(streetname)  # type: ignore  # noqa: PGH003
